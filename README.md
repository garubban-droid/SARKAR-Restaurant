...
Changes are stored in the server-side SQLite settings/database layer and are consumed by the Customer App through `/api/settings` and related API endpoints.
