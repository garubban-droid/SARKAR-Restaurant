...
app.post('/api/customer/auth/signup',async(req,res)=>{
  ...
  try{
    ...
    const r=await client.query(`INSERT INTO customers(name,phone,email,password_hash,referral_code,referred_by_customer_id,device_fingerprint_hash,signup_ip_hash)
